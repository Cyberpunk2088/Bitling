...
MUTATIONS = (
    ...
    Mutation(
        "break_live_runtime_inheritance",
        Path("scripts/core/habitat_live_action_runtime.gd"),
    ...
    Mutation(
        ...
        "compatibility choices pass through the authoritative resolver",
    ),
    Mutation(
        "show_production_choice_cards",
        Path("scripts/ui/ultimate_dashboard_live_action.gd"),
        "_choice_card.visible = false",
        "_choice_card.visible = true",
        "production hides compatibility choice cards from the primary loop",
    ),
    Mutation(
        "bypass_live_sequence",
        Path("scripts/ui/ultimate_dashboard_live_action.gd"),
        'service.call("begin_choice_sequence", choice_id)',
        'service.call("resolve_choice", choice_id)',
        "production choices use the visible action sequence",
    ),
    Mutation(
